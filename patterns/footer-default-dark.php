...
<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Your Company LLC', 'mako' ); ?> · <a href="#"><?php echo esc_html__( 'Contact Us', 'mako' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Facebook', 'mako' ); ?></a> · <a href="#"><?php echo esc_html__( 'Twitter', 'mako' ); ?></a> · <a href="#"><?php echo esc_html__( 'Instagram', 'mako' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
