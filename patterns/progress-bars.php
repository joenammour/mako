...
<p><?php echo esc_html__( 'Item #1', 'mako' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '100%', 'mako' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #2', 'mako' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '90%', 'mako' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #3', 'mako' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '80%', 'mako' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #4', 'mako' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '70%', 'mako' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #5', 'mako' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '60%', 'mako' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
...
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph -->
<p><?php echo esc_html__( 'Item #6', 'mako' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( '50%', 'mako' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- wp:group {"backgroundColor":"contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:spacer {"height":"20px"} -->
